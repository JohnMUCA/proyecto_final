...
void nivel::key_event(QKeyEvent *event)
{
    ...
    {
        murcielago->realizarMovimientoCircular(murcielago->x(),murcielago->y(),100,1,1);
    }
}
...
void nivel::setup_murcielago()
{
    ...
    murcielago = new Murcielago(completeAnimationsMurcielago(), numsFotogramasMurcielago, ":/imagenes/murcielago.png", anchoMurcielago, alturaMurcielago, scaleMurcielago);
